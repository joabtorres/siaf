<div id="section-container">
    <div class="row" >
        <div class="col-sm-12 col-md-12 col-lg-12" id="pagina-header">
            <h2>Cadastrar Avaliação Física</h2>
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-plus-square"></i> Cadastrar Avaliação Física</li>
            </ol>
        </div>
    </div>
    <!--FIM pagina-header-->
            ...
            <form autocomplete="off" method="POST" id="myFormFinanca">
                <section class="panel panel-black">
                    <header class="panel-heading">
                        <h4 class="panel-title"><i class="fa fa-plus-square pull-left"></i>Avaliação Física</h4>
                    </header>
                    <article class="panel-body">
                        <div class="row">
                            <input type="hidden" name="nCodAluno" value="<?php echo!empty($formCad['cod_aluno']) ? $formCad['cod_aluno'] : $aluno['cod']; ?>"/>
                            <input type="hidden" name="nCodAvaliacao" value="<?php echo!empty($formCad['cod']) ? $formCad['cpd'] : null; ?>"/>
                            <div class="col-md-3">
                                <div class="row">
