            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-offset-1 col-sm-10 col-md-offset-3 col-md-6 col-lg-offset-4 col-lg-4" id="tela_login">
                        ...
                        <div class="row">
                            <div class="col-md-offset-1 col-md-10"><img src="<?php echo BASE_URL; ?>/assets/imagens/logo_login.png" alt="Logotipo da <?php echo NAME_PROJECT ?>" class="img-center img-login img-responsive"> <br/></div>
                            <div class="col-md-12">
                                <form method="POST">
